...
const Details=()=> {
  ...
  const auth = 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxODkxMTk4Iiwicm9sZXMiOlsiUk9MRV9VU0VSIl0sImlhdCI6MTY3MzU3MjA2MCwiZXhwIjoxNjczNTc1NjYwfQ.9kXYhr08b2V2fjjQg4t7OTiE6Pmy9wzTZJz1b_gJvOw';
  const method = 'get';
